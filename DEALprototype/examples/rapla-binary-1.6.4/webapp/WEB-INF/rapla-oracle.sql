...
(
  ...
  REPETITION_TYPE      VARCHAR2(15 BYTE),
...
(
  ID            INTEGER                         NOT NULL,
  PARENT_ID     INTEGER,
  CATEGORY_KEY  VARCHAR2(50 BYTE)               NOT NULL,
...
(
  ID          INTEGER                           NOT NULL,
  TYPE_KEY    VARCHAR2(20 BYTE)                 NOT NULL,
...
(
  EVENT_ID       INTEGER                        NOT NULL,
  ATTRIBUTE_KEY  VARCHAR2(20 BYTE)              NOT NULL,
...
(
  RESOURCE_ID    INTEGER                        NOT NULL,
  ATTRIBUTE_KEY  VARCHAR2(25 BYTE),
  VALUE          VARCHAR2(200 BYTE)
) ;


DROP TABLE RESOURCE_GROUP CASCADE CONSTRAINTS;
...
DROP TABLE PREF CASCADE CONSTRAINTS;

CREATE TABLE PREF
(
  USER_ID       INTEGER,
  ROLE          VARCHAR2(200 BYTE)              NOT NULL,
  STRING_VALUE  VARCHAR2(2000 BYTE),
  XML_VALUE     VARCHAR2(2000 BYTE)
) ;
