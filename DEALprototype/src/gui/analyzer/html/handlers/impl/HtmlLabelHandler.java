...
public class HtmlLabelHandler extends AbstractHtmlHandler {
	...
	String value = null;
		...
		public boolean matches(Element element) {
			...
			boolean matches = isLabel(element);
			
			return matches;
		}
		
		/**
		 * Metoda specificka pre element Label <label>.
		 * @param element
		 * @return
		 */
		...
		/*************** Singleton pattern *************/
		private static HtmlLabelHandler instance;
		
		public static HtmlLabelHandler getInstance() {
			if(instance == null) {
				instance  = new HtmlLabelHandler();
			}
			return (HtmlLabelHandler) instance;
		}
		
		private HtmlLabelHandler() {}
