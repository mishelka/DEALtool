...
public class WindowsCheckBoxHandler extends AbstractWindowsHandler {
	...
	/**
	 * vrati true ak je to checkbox, false ak nie je
	 */
	@Override
	public boolean matches(Element element) {
		if(element == null) return false;
		return isCheckBox(element);
	}
	...
	private boolean isCheckBox(Element element) {
		...
		if(elemName.equals("element")) {
			...
			if (roleAttr != null) {
				if (roleAttr.equalsIgnoreCase("checkbox")) {
					return true;
				}
			}
		}
	...
	/*************** Singleton pattern *************/
	private static WindowsCheckBoxHandler instance;
	
	public static WindowsCheckBoxHandler getInstance() {
		if(instance == null) {
			instance  = new WindowsCheckBoxHandler();
		}
		return (WindowsCheckBoxHandler) instance;
	}
	
	private WindowsCheckBoxHandler() {}
